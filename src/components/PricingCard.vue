<template>
  <div
    v-bind:class="
      isRecommended
        ? 'bg-blue-600 rounded-lg py-5 p-8 sm:p-8 w-full box-border border-[1px] md:scale-[1.10]'
        : 'bg-gray-200 rounded-lg p-8 mx-0 md:mx-5 w-full box-border'
    "
  >
    <h3
      v-bind:class="
        isRecommended ? 'text-xl font-bold text-white mb-4' : 'text-xl font-bold text-gray-900 mb-4'
      "
    >
      {{ title }}
    </h3>
    ...
    <div class="space-y-4 mb-8">
      <p
        ...
        :key="index"
        v-bind:class="isRecommended ? 'text-gray-100' : 'text-gray-600'"
      >
        {{ feature }}
      </p>
    </div>
